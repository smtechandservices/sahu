...
const AboutConstitution = () => {
  return (
    <section className="section-padding bg-[#FFFBF7]">
      <div className="px-8">
        <div className="max-w-4xl mx-auto bg-white border border-yellow-200 rounded-md shadow-base p-8 md:p-12 text-center">
          <motion.div
