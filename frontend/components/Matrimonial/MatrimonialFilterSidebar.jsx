...
const MatrimonialFilterSidebar = ({
  ...
  return (
    <aside className="w-full lg:w-72 flex-shrink-0">
      ...
      <button
        className="lg:hidden w-full flex items-center justify-between bg-white border border-gray-200 rounded-xl px-4 py-3 mb-2 shadow-sm font-bold text-gray-700"
      ...
      {/* Filter panel */}
      <div className={`${mobileOpen ? 'block' : 'hidden'} lg:block bg-white border border-gray-200 rounded-xl p-6 h-fit lg:sticky top-24 shadow-sm`}>
