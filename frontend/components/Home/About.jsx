      ...
      <div className="px-8 flex flex-col lg:flex-row items-center gap-20">
        <div className="relative">
          <div className="overflow-hidden">
            <Image src="/assets/president.png" alt="President Ranvijay Sahu" width={200} height={300} className='w-200' />
          </div>
          <div className='mt-4'>
        ...
        <div>
          ...
          <p className="text-xl md:text-2xl leading-relaxed italic text-[#564337] mb-10">
